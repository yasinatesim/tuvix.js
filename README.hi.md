...
- 📦 **स्वतंत्र डिप्लॉयमेंट** — प्रत्येक माइक्रो ऐप को अलग से डिप्लॉय करें
...
- ⚡ **हल्का** — शून्य रनटाइम डिपेंडेंसी, न्यूनतम कोर
- 🔄 **लाइफसाइकिल मैनेजमेंट** — Mount, unmount, update हुक्स
- 🔒 **टाइप-सेफ** — स्ट्रिक्ट टाइप्स के साथ पूर्ण TypeScript सपोर्ट
...
| [`@tuvix.js/core`](./packages/core) | लाइफसाइकिल मैनेजमेंट के साथ कोर ऑर्केस्ट्रेटर |
