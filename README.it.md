...
- **Alimentato da:** Ollama + DeepSeek Coder (funziona 100% localmente, nessun costo API)
- **Basato su RAG:** Recupera esempi rilevanti da 320 esempi di componenti open-source
