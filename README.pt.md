...
- **Movido por:** Ollama + DeepSeek Coder (roda 100% localmente, sem custos de API)
- **Baseado em RAG:** Recupera exemplos relevantes de 320 exemplos de componentes open-source
